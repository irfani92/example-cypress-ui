      ...
      cy.get("#ShareModal .modal-dialog .list a").each(($li) => {
        ...
        if ($li.attr('class') === "email") {
          cy.get($li).should('have.attr', 'href'
            , 'mailto:example@mail.com?subject=https://sustainablecottonhub.org/cotton-papers')
        } else {
          cy.get($li).should('have.attr', 'data-share-url', 'https://sustainablecottonhub.org/cotton-papers')
        }
